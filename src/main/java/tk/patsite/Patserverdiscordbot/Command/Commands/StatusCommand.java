...
import tk.patsite.Patserverdiscordbot.Cache.WeightedCacheTimeoutIfX;
...
public class StatusCommand extends Command {
    ...
    private final Cache<Boolean> onlineCache = new WeightedCacheTimeoutIfX<>(120000L, 3000L, () -> CheckServerOnline.IsServerOnline(Settings.IP).join(), true);
